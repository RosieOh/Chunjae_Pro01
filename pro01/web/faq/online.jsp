    ...
    <div class="contents">
        <div class="contents" id="contents">
            <div class="breadcrumb">
                <p><a href="/">HOME</a> &gt; <a href="">상담</a> &gt; <span>온라인 상담</span></p>
            </div>
                ...
                <div class="page_wrap">
                    ...
                    <form action="onlinePro.jsp" method="post">
                      <table class="tb1">
                          ...
                          <tr>
                              <th><label for="from">email 주소</label></th>
                          ...
                          <tr>
                              ...
                              <td><textarea rows="6" cols="100" maxlength="990" name="content" id="content" class="indata2"></textarea></td>
                          </tr>
                          </tbody>
                      </table>
                        <div class="btn_group">
